export const ApplicationName = "sellifyspa";
...
const ssoHost = "https://localhost:5001/";
let applicationPaths: ApplicationPathsType = {
  DefaultLoginRedirectPath: "/",
  ApiAuthorizationClientConfigurationUrl: `${ssoHost}_configuration/${ApplicationName}`,
  ...
  IdentityRegisterPath: `${ssoHost}Identity/Account/Register`,
  IdentityManagePath: `${ssoHost}Identity/Account/Manage`
};
